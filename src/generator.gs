...
list instruction_names = ["set","add","sub","mul","div","inc","eq","lt","gt","and","or","not","lteq","gteq","dec","mod","jump","jump_if_true","jump_if_false","jump_by","min","max","call","return","random","pow","abs","round","floor","ceil","sqrt","sin","cos","tan","switch","lerp","asin","acos","atan","atan2","mag2","ln","log","antiln","antilog","special","unlerp","letter_of","join","mag3","print"];
                ...
                if (opcode < 45) {
                    ...
                    if (opcode < 48) {
                        ...
                        if (opcode < 49) {
                            ...
                            if (opcode < 50) {
                                # 49: mag3
                                MEM1 = VEC3_LEN(MEM2, MEM3, MEM4);iptr += 5;
                            } else {
                                # 50: print
